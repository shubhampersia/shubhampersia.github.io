...
const projects = [
  {
    ...
    image: project1,
    link: "https://hifichat.vercel.app/",
    description: [
...
<li key={index} className="project-item active">
  {proj.link ? (
    <a href={proj.link} target="_blank" rel="noopener noreferrer">
      ...
      <ul className="project-category" style={{ paddingLeft: '1.2rem', marginTop: '0.5rem' }}>
        {proj.description.map((point, i) => (
          <li key={i} style={{ marginBottom: '6px', listStyleType: 'disc' }}>
            {point}
          </li>
        ))}
      </ul>
