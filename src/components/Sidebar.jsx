        ...
        <aside className={`sidebar ${expanded ? 'active' : ''}`} data-sidebar>
            <div className="sidebar-info">
                ...
                <div className="info-content">
                    <h1 className="name" title="shubham">SHUBHAM</h1>
                    <p className="title">Full Stack Developer</p>
                    <br></br>
                    <p className='download-resume'>
                        <a
                            href="https://drive.google.com/file/d/1MNcljEQ9J4wQe0vCeIpRDeQUlZZF2W7r/view?usp=sharing"
                            target="_blank"
            ...
            <div className="sidebar-info_more">
                ...
                <ul className="contacts-list">
                    <li className="contact-item">
                        ...
                        <div className="contact-info">
                            ...
                            <a href="mailto:shubhampersia512@gmail.com" className="contact-link">shubhampersia512@gmail.com</a>
                        </div>
                    </li>
                    {/* <li className="contact-item">
                ...
                <ul className="social-list">
                    <li className="social-item">
                        <a href="https://www.linkedin.com/in/shubham-shubham-b8a446112/"
                    ...
                    <li className="social-item">
                        <a href="https://github.com/shubhampersia"
                            className="social-link"
                            target="_blank"
                            rel="noopener noreferrer">
                            <IoLogoGithub /></a>
